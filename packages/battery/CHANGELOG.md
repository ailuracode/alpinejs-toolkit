...
- d43b218: Add `@ailuracode/alpinejs-battery` with reactive `$battery` magic for device battery level and charging state when the Battery Status API is available.
