...
## `@ailuracode/alpine-env` — platform detection
...
- [`@ailuracode/alpine-core`](./core.md) — SSR-safe browser helpers (`isBrowser`, `safeWindow`, `safeMatchMedia`) for custom plugins
