...
function CardDescription({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("text-sm text-[var(--ios-label-secondary)]", className)}
      {...props}
    />
  )
}
...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex items-center rounded-b-[var(--ios-radius-lg)] border-t border-[var(--ios-separator)] bg-[var(--ios-fill-quaternary)] p-(--card-spacing)",
        className
      )}
      {...props}
    />
